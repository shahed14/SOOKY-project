...
<div class="page">
 ...
 <!-- Add an id attribute to the "Generate Link" input -->
<div class="btn-cart btn-cart1">
    <input type="submit" value="generate link" name="generate-link" onclick="generateLink()">
  <a href="../refferal/index.php">go to referral</a>
</div>                     </div>
                            </form>
							<div class="share">
...
function generateLink() {
    // Get the current URL of the product page
    var currentURL = window.location.href;

    // Construct the referral link with the complete URL
    var referralLink = "lastSOOKY/refferal/index.php?url=" + encodeURIComponent(currentURL);

    // Show the alert with the complete URL
    alert("Copied URL: " + currentURL);

    // Redirect to "referral/index.php"
