...
<div class="header" style="height: 70px; background-color: white;">
	<div class="container">
		<div class="row inner">
			<div class="col-md-4 ">
				<a href="../home2.php"><img src="../image/logo2.png" alt="logo image" height="70px" width="100px" style="margin-left: -10em;"></a>
			</div>
			...
			<div class="col-md-5 right">
				<ul>
					...
					if(isset($_SESSION['customer'])) {
						...
						<li><a href="dashboard.php" style="color: orange; font-weight: bold; font-size: 18px;"><i class="fa fa-home"></i> <?php echo LANG_VALUE_89; ?></a></li>
						<?php
					} else {
						?>
						<li ><a href="login.php" style="color: orange; font-weight: bold; font-size: 18px;"><i class="fa fa-sign-in"></i> <?php echo LANG_VALUE_9; ?></a></li>
						<li><a href="registration.php" style="color: orange; font-weight: bold; font-size: 18px;"><i class="fa fa-user-plus"></i> <?php echo LANG_VALUE_15; ?></a></li>
						<?php	
					}
					?>

					<li><a href="cart.php" style="color: orange; font-weight: bold; font-size: 18px;"><i class="fa fa-shopping-cart"></i> <?php echo LANG_VALUE_18; ?> (<?php echo LANG_VALUE_1; ?><?php
			...
			<div class="col-md-3 search-area">
				<form class="navbar-form navbar-left" role="search" action="search-result.php" method="get">
					...
					<button type="submit" class="btn btn-primary" style="background-color: orange; color: white; font-size: 17px; font-weight: bold;"><?php echo LANG_VALUE_3; ?></button>
				</form>
			</div>
		</div>
	</div>
...
<div class="nav" style="background-color: darkorange;">
	<div class="container" style="background-color: darkorange;">
		<div class="row"style="background-color: darkorange;">
			<div class="col-md-12 pl_0 pr_0">
				<div class="menu-container" style="background-color: darkorange;">
					<div class="menu" >
						<ul>
